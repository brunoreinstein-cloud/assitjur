  ...
  try {
    ...
    if (profileError || !profile) {
      return new Response(
        JSON.stringify({
          error:
            "E-mail não encontrado nos nossos registros. Verifique se está usando o mesmo e-mail cadastrado.",
        }),
        {
          status: 404,
          headers: {
    ...
    switch (requestType) {
      case "ACCESS":
        responseMessage =
          "Solicitação de acesso aos dados registrada com sucesso.";
        processingInfo =
          "Você receberá um relatório completo com todos os seus dados pessoais em nosso sistema.";
        break;
      case "RECTIFICATION":
        responseMessage = "Solicitação de retificação registrada com sucesso.";
        processingInfo =
          "Nossa equipe irá verificar e corrigir as informações identificadas como incorretas.";
        break;
      case "DELETION":
        responseMessage = "Solicitação de exclusão registrada com sucesso.";
        processingInfo =
          "Seus dados serão avaliados para exclusão, respeitando obrigações legais de retenção.";
        break;
      case "PORTABILITY":
        responseMessage =
          "Solicitação de portabilidade registrada com sucesso.";
        processingInfo =
          "Você receberá seus dados em formato estruturado (JSON/CSV) para uso em outras plataformas.";
        break;
    }
