...
-- Add RLS policies for pessoas_masked table
ALTER TABLE public.pessoas_masked ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Restricted access to pessoas_masked data" 
...
-- Similarly for processos_masked
ALTER TABLE public.processos_masked ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Restricted access to processos_masked data"
...
-- Now create the Mapa de Testemunhas module

-- Create hubjuria schema
