-- ============================================================================
-- MIGRATION: Mapa das Testemunhas - Sistema de Filtros e Atualizações
-- Schema: assistjur
-- Data: 2025-01-07
-- 
...
-- 9. VIEW DE LEITURA PÚBLICA (sem nota_interna)
-- ============================================================================
...
-- Se tenant_id foi adicionado em processos_testemunhas existente, execute:
