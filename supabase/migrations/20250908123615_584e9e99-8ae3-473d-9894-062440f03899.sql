...
INSERT INTO audit_logs (
  ...
  jsonb_build_object(
    ...
    'security_impact', 'Critical: Eliminated potential unauthorized data access'
  ),
  inet '127.0.0.1',
