...
console.log(
  "  1. Execute: npm install (para garantir integridade dos pacotes)",
);
console.log("  2. Execute: npm run dev (para rebuild completo)");
console.log("  3. Aguarde o build finalizar antes de testar");
console.log("\n🔍 VERIFICAÇÃO:");
console.log(
  '  - Console de dev: verifique se há logs "[DEBUG]" nas Edge Functions',
);
console.log(
  '  - Network tab: verifique se as RPCs retornam dados com "confidence"',
);
