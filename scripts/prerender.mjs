...
function getPageDescription(route) {
  const descriptions = {
    "/mapa":
      "Navegue pelo mapa completo do site AssistJur.IA e encontre rapidamente o que procura.",
    "/planos":
      "Conheça nossos planos e escolha a melhor opção para suas necessidades jurídicas.",
    "/contato":
      "Entre em contato conosco. Estamos aqui para ajudar com suas dúvidas.",
    "/blog":
      "Artigos e insights sobre inteligência artificial aplicada ao direito.",
    "/termos": "Termos de uso da plataforma AssistJur.IA.",
    "/privacidade":
      "Política de privacidade e proteção de dados da AssistJur.IA.",
  };
  return (
    descriptions[route] ||
    "Inteligência artificial especializada em análise jurídica e processamento de documentos legais."
  );
}
