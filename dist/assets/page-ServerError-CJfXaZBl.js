...
import { C as j, j as p, k as f, m as b, a } from "./page-About-RKuI2z9S.js";
import { I as N } from "./page-Login-5_M3Gm0y.js";
import { S as v } from "./page-NotFound-cpOlfL10.js";
const B = ({ onRetry: l }) => {
          ...
          children: [
            e.jsxs(p, {
              ...
              children: [
                e.jsx("div", {
                  className:
                    "mx-auto w-12 h-12 bg-destructive/10 rounded-full flex items-center justify-center mb-4",
                  children: e.jsx(d, { className: "w-6 h-6 text-destructive" }),
                }),
                e.jsx(f, { children: "Erro interno do servidor" }),
              ],
            }),
            e.jsxs(b, {
              className: "space-y-4",
