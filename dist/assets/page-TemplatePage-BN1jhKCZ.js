...
import { T as I, c as M, d as w, e as y } from "./page-Login-5_M3Gm0y.js";
import { t as J, v as V } from "./page-MapaPage-DdhKmZnw.js";
function v({
  title: d,
  description: a,
  downloadUrl: s,
  ...
  return e.jsxs(n, {
    className: `relative transition-all hover:shadow-lg ${g ? "border-primary" : ""}`,
    children: [
      g &&
        e.jsx("div", {
          ...
          children: e.jsx("div", {
            className:
              "bg-primary text-primary-foreground text-xs px-2 py-1 rounded-full font-medium",
      ...
      e.jsxs(m, {
        children: [
          e.jsxs(x, {
            ...
            children: [
              t === "xlsx"
                ? e.jsx(f, { className: "h-6 w-6 text-green-600" })
                : e.jsx(D, { className: "h-6 w-6 text-blue-600" }),
              d,
            ],
          }),
          e.jsx(h, { className: "text-sm", children: a }),
        ],
      }),
      e.jsx(i, {
        children: e.jsxs(_, {
          ...
          children: [e.jsx(C, { className: "h-4 w-4 mr-2" }), "Baixar ", u],
        }),
      }),
    ],
  });
...
function $() {
  const d = J.filter((t) => t.Aba === "Por Processo"),
    a = J.filter((t) => t.Aba === "Por Testemunha"),
    s = (t, u, g) =>
      e.jsxs(n, {
        children: [
          e.jsxs(m, {
            children: [
              e.jsxs(x, {
                ...
                children: [u === 'Aba "Por Processo"' ? "⚖️" : "👤", u],
              }),
              e.jsx(h, { children: g }),
            ],
          }),
              ...
              children: e.jsxs(P, {
                children: [
                  e.jsx(T, {
                    children: e.jsxs(p, {
                      children: [
                        e.jsx(r, { className: "min-w-32", children: "Campo" }),
                        e.jsx(r, { children: "Tipo" }),
                        e.jsx(r, {
                          className: "text-center",
                          children: "Obrigatório",
                        }),
                        e.jsx(r, { children: "Regra de Validação" }),
                        e.jsx(r, {
                          className: "min-w-40",
                          children: "Exemplo",
                        }),
  ...
  return e.jsxs(n, {
    children: [
      e.jsxs(m, {
        children: [
          e.jsx(x, { children: "Dicionário de Campos" }),
          e.jsxs(h, {
            className: "text-sm",
            children: [
              e.jsx("strong", {
                children: "CONFORMIDADE COM NOVAS ESPECIFICAÇÕES:",
              }),
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", { children: "Abas obrigatórias:" }),
              ' "Por Processo" + "Por Testemunha"',
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", {
                children: "Campos obrigatórios Por Processo:",
              }),
              " cnj, uf, comarca, reclamante_nome, reu_nome, advogados_ativo, todas_testemunhas",
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", {
                children: "Campos obrigatórios Por Testemunha:",
              }),
              " nome_testemunha, qtd_depoimentos, cnjs_como_testemunha",
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", { children: "Sistema de sinônimos:" }),
              " Reconhece variações de nomes de colunas automaticamente",
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", { children: "Parser de listas:" }),
              " Suporta formatos JSON-like, separação por ; e ,",
              e.jsx("br", {}),
              "✅ ",
              e.jsx("strong", { children: "CNJ preservado:" }),
              " Formato original mantido como string",
            ],
          }),
        ],
      }),
        ...
        children: e.jsxs(I, {
          ...
          children: [
            e.jsxs(M, {
              ...
              children: [
                e.jsx(w, { value: "processo", children: "Por Processo" }),
                e.jsx(w, { value: "testemunha", children: "Por Testemunha" }),
              ],
            }),
            e.jsx(y, {
              value: "processo",
  ...
  B = [
    {
      ...
      qtd_depoimentos: 3,
      cnjs_como_testemunha: `['${c[0]}','${c[1]}','${c[2]}']`,
      reclamante_nome: "",
      reu_nome: "",
    },
    {
    ...
    },
    {
      ...
      qtd_depoimentos: 3,
      cnjs_como_testemunha: `["${c[0]}","${c[3]}","${c[4]}"]`,
      reclamante_nome: "",
      reu_nome: "",
    },
  ];
function G() {
  ...
  return e.jsxs(n, {
    children: [
      e.jsxs(m, {
        children: [
          e.jsx(x, { children: "Exemplos Visuais dos Templates" }),
          e.jsx(h, {
            children:
              ...
              children: [
                e.jsxs(m, {
                  children: [
                    e.jsx(x, {
                      className: "text-lg",
                      children: 'Exemplos - Aba "Por Processo"',
                    }),
                    e.jsx(h, {
                      children:
                ...
                e.jsxs(i, {
                  children: [
                      ...
                      children: e.jsxs(P, {
                        children: [
                          e.jsx(T, {
                            children: e.jsxs(p, {
                              children: [
                                e.jsx(r, { children: "CNJ" }),
                                e.jsx(r, { children: "UF" }),
                                e.jsx(r, { children: "Comarca" }),
                                e.jsx(r, { children: "Reclamante" }),
                                e.jsx(r, { children: "Réu" }),
                                e.jsx(r, { children: "Advogados Ativo" }),
                                e.jsx(r, { children: "Todas Testemunhas" }),
                              ],
                            }),
                          }),
                          e.jsx(A, {
                              ...
                              e.jsxs(
                                p,
                                {
                                  children: [
                                    ...
                                    e.jsx(o, { children: s.uf }),
                                    e.jsx(o, { children: s.comarca }),
                                    e.jsx(o, { children: s.reclamante_nome }),
                                    e.jsx(o, { children: s.reu_nome }),
                                    e.jsx(o, {
                                      className: "text-xs max-w-32 truncate",
                                      children: s.advogados_ativo,
                                    }),
                                    e.jsx(o, {
                                      className: "text-xs max-w-32 truncate",
                                      children: s.todas_testemunhas,
                                    }),
                                  ],
                                },
                                t,
                    ...
                    e.jsxs("p", {
                      ...
                      children: [
                        e.jsx("strong", { children: "Campos obrigatórios:" }),
                        " cnj, uf, comarca, reclamante_nome, reu_nome, advogados_ativo, todas_testemunhas",
                      ],
                    }),
                  ],
              ...
              children: [
                e.jsxs(m, {
                  children: [
                    e.jsx(x, {
                      className: "text-lg",
                      children: 'Exemplos - Aba "Por Testemunha"',
                    }),
                    e.jsx(h, {
                      children:
                ...
                e.jsxs(i, {
                  children: [
                      ...
                      children: e.jsxs(P, {
                        children: [
                          e.jsx(T, {
                            children: e.jsxs(p, {
                              children: [
                                e.jsx(r, { children: "Nome Testemunha" }),
                                e.jsx(r, { children: "Qtd Depoimentos" }),
                                e.jsx(r, { children: "CNJs Como Testemunha" }),
                                e.jsx(r, {
                          ...
                          e.jsx(A, {
                            children: a.map((s, t) =>
                              e.jsxs(
                                ...
                                {
                                  children: [
                                    e.jsx(o, { children: s.nome_testemunha }),
                                    e.jsx(o, {
                                      className: "text-center",
                                      children: s.qtd_depoimentos,
                                    }),
                                    e.jsx(o, {
                                      className:
                                        "font-mono text-xs max-w-xs truncate",
                                      children: s.cnjs_como_testemunha,
                                    }),
                                    e.jsx(o, {
                    ...
                    e.jsxs("div", {
                      className: "space-y-1 text-xs text-muted-foreground mt-2",
                      children: [
                        e.jsxs("p", {
                          children: [
                            e.jsx("strong", {
                        ...
                        e.jsx("p", {
                          children: e.jsx("strong", {
                            children:
                              "Formatos aceitos para cnjs_como_testemunha:",
                          }),
                        }),
                        e.jsx("p", {
                          children: "• JSON-like: ['CNJ1','CNJ2']",
                        }),
                        e.jsx("p", {
                          children: "• Separado por ;: CNJ1; CNJ2",
                        }),
                        e.jsx("p", {
                          children: "• Separado por ,: CNJ1, CNJ2",
                        }),
...
function Y() {
  const d = U.reduce(
    (a, s) => (a[s.category] || (a[s.category] = []), a[s.category].push(s), a),
    {},
  );
  return e.jsxs(n, {
    children: [
      e.jsxs(m, {
        children: [
          ...
          e.jsx(h, {
            children:
              "Siga este checklist para garantir que seus dados passem pela validação automática",
          }),
        ],
      }),
      e.jsx(i, {
        children: e.jsx("div", {
          className: "space-y-6",
          children: Object.entries(d).map(([a, s]) =>
            e.jsxs(
              "div",
              {
                className: "space-y-3",
                children: [
                  e.jsxs("h4", {
                    className:
                      "font-medium text-sm uppercase tracking-wide text-muted-foreground flex items-center gap-2",
                    children: [
                      e.jsx("span", { className: "text-base", children: H[a] }),
                      a === "critical" && "CRÍTICO",
                      a === "required" && "OBRIGATÓRIO",
                      a === "format" && "FORMATO",
                      a === "validation" && "VALIDAÇÃO",
                      a === "safety" && "SEGURANÇA",
                    ],
                  }),
                  e.jsx("div", {
                    ...
                    children: s.map((t, u) =>
                      e.jsx(
                        "div",
                        {
                          className: `p-4 rounded-lg border ${X[t.category]}`,
                          children: e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("div", {
                children: [
                  e.jsx("p", {
                    className:
                      "font-medium text-sm text-orange-800 dark:text-orange-200",
                    children: "Validação Jurídica Obrigatória",
                  }),
                  e.jsx("p", {
                    className:
                      "text-sm text-orange-700 dark:text-orange-300 mt-2",
                    children:
                  ...
                  e.jsx("p", {
                    className:
                      "text-xs text-orange-600 dark:text-orange-400 mt-2 font-medium",
                    children:
            ...
            children: [
              ...
              e.jsxs("div", {
                children: [
                  e.jsx("p", {
                    className:
                      "font-medium text-sm text-blue-800 dark:text-blue-200",
                    children: "Segurança e Privacidade (LGPD)",
                  }),
                  e.jsx("p", {
                  ...
                  e.jsxs("div", {
                    className:
                      "space-y-1 mt-3 text-xs text-blue-600 dark:text-blue-400",
                    children: [
                      e.jsxs("div", {
                        className: "flex items-center gap-2",
                        children: [
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx("span", { children: "Conformidade com LGPD" }),
                        ],
                      }),
                      e.jsxs("div", {
                        className: "flex items-center gap-2",
                        children: [
                          e.jsx("span", { children: "🗑️" }),
                          e.jsx("span", {
                            children: "Retenção controlada de dados",
                          }),
                        ],
                      }),
                    ],
  ...
  return e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [
        e.jsxs("div", {
          ...
          children: [
            e.jsxs(b, {
              to: "/import",
              className:
                "inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-6",
              children: [
                e.jsx(L, { className: "h-4 w-4 mr-2" }),
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx(f, { className: "h-10 w-10 text-primary" }),
                    e.jsx("h1", {
                      className:
                        "text-4xl font-bold tracking-tight text-foreground",
                      children: "Templates de Importação",
                    }),
                  ],
                }),
                e.jsx("p", {
            ...
            e.jsxs(z, {
              className: "mt-6 border-blue-200 bg-blue-50 dark:bg-blue-950",
              children: [
                e.jsx(q, { className: "h-4 w-4 text-blue-600" }),
                e.jsxs(F, {
                  className: "text-blue-800 dark:text-blue-200",
                  children: [
                    e.jsx("strong", { children: "Novas Diretrizes:" }),
                    " Validação rigorosa com mapeamento estrito de colunas e CNJs com 20 dígitos exatos",
                  ],
                }),
              ],
            }),
              ...
              children: e.jsxs("div", {
                ...
                children: [
                  e.jsx(v, {
                    ...
                    description:
                      "Arquivo completo com 3 abas: Por Processo, Por Testemunha e Dicionário de Campos",
                    downloadUrl:
                      "https://fgjypmlszuzkgvhuszxn.functions.supabase.co/templates-xlsx",
                    icon: "xlsx",
                  ...
                  e.jsx(v, {
                    ...
                    description:
                      "Apenas dados de processos em formato CSV (separador ponto e vírgula)",
                    downloadUrl:
                      "https://fgjypmlszuzkgvhuszxn.functions.supabase.co/templates-csv?sheet=Por%20Processo",
                    icon: "csv",
                  ...
                  e.jsx(v, {
                    ...
                    description:
                      "Apenas dados de testemunhas em formato CSV (separador ponto e vírgula)",
                    downloadUrl:
                      "https://fgjypmlszuzkgvhuszxn.functions.supabase.co/templates-csv?sheet=Por%20Testemunha",
                    icon: "csv",
        ...
        e.jsx("div", { className: "mb-12", children: e.jsx(Y, {}) }),
        e.jsx("div", { className: "mb-12", children: e.jsx($, {}) }),
        e.jsx("div", { className: "mb-12", children: e.jsx(G, {}) }),
        e.jsx("div", { className: "mb-12", children: e.jsx(Z, {}) }),
        e.jsx(n, {
          className: "text-center",
          children: e.jsxs(i, {
            className: "pt-8 pb-8",
                ...
                children: [
                  e.jsx(b, {
                    ...
                    children: e.jsxs(_, {
                      ...
                      className: "px-8",
                      children: [
                        e.jsx(f, { className: "h-5 w-5 mr-2" }),
                  ...
                  e.jsx(b, {
                    ...
                    children: e.jsxs(_, {
                      ...
                      className: "px-8",
                      children: [
                        e.jsx(C, { className: "h-5 w-5 mr-2" }),
                        "Base de Dados (Admin)",
                      ],
                    }),
                  }),
