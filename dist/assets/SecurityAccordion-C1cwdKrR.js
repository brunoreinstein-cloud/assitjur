              ...
              children: a.map((s) =>
                e.jsxs(
                  x,
                  {
                    value: s.id,
                    className:
                      "border border-border/50 rounded-lg px-6 bg-card",
                    children: [
                      e.jsx(p, {
                      ...
                      e.jsx(u, {
                        ...
                        children: e.jsx("p", {
                          className:
                            "text-muted-foreground leading-relaxed ml-13",
                          children: s.content,
                        }),
                      }),
                    ],
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h3", {
                ...
                children: "Certificações destacadas",
              }),
              e.jsx("div", {
                ...
                children: t.map((s, o) =>
                  e.jsxs(
                    h,
                    {
                      variant: "outline",
                      className:
                        "px-4 py-2 text-sm font-medium border-primary/20 text-primary hover:bg-primary/10 transition-colors",
                      children: [
                        e.jsx("span", {
