...
- **`src/components/privacy/ConsentDialog.tsx`**: UI em formato _bottom sheet_ com ações "Aceitar tudo", "Rejeitar tudo" e "Salvar preferências". Categorias: Essenciais (fixo), Medição e Publicidade. Opcionalmente habilita "Compartilhamento" ajustando `SHARING_ENABLED`.
