            ...
            >
              <Suspense fallback={<div className="p-4">Carregando...</div>}>
                <Routes>
                  ...
                  <Route
                    path="/demo/mapa-testemunhas"
                    element={<DemoMapaTestemunhas />}
                  />
                          ...
                          <ErrorBoundary>
                            ...
                            >
                              <Routes>
                                ...
                                <Route
                                  path="/admin/ia/chaves"
                                  element={<OpenAIKeys />}
                                />
                                <Route
                                  path="/admin/ia/modelos"
                                  element={<OpenAIModels />}
                                />
                                <Route
                                ...
                                />
                                <Route
                                  path="/admin/ia/testes"
                                  element={<OpenAIPlayground />}
                                />
                                <Route
                                  path="/admin/base-import"
                                  element={<ImportBase />}
                                />
                                <Route
                                ...
                                >
                                  <Route
                                    path="processos"
                                    element={<ProcessosTable />}
                                  />
                                  <Route
                                    path="testemunhas"
                                    element={<TestemunhasTable />}
                                  />
                                </Route>
                                <Route
                                  path="/import"
                                  element={
                                    <Navigate to="/admin/base-import" replace />
                                  }
                                />
                                <Route
                                  path="/admin/versoes"
