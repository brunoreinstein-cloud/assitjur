...
export const CANONICAL_COLUMN_SYNONYMS: CanonicalColumnSynonym[] = [
  ...
  {
    canonical: "Comarca",
    synonyms: ["Comarca", "comarca", "COMARCA", "municipio", "cidade", "local"],
    required: true,
    sheet: "processo",
    type: "string",
  },
  ...
  },
  {
    ...
    synonyms: [
      ...
      "quantidade_reclamante_testemunha",
    ],
    required: false,
    sheet: "processo",
    type: "number",
  },
  {
    ...
    synonyms: [
      ...
      "cnjs_reclamante_foi_testemunha",
    ],
    required: false,
    sheet: "processo",
    type: "list",
  ...
  },
  {
    ...
    synonyms: ["CNJs_Passivo", "cnjs_passivo", "cnjs_polo_passivo"],
    required: false,
    sheet: "processo",
    type: "list",
  },
  ...
  },
  {
    ...
    synonyms: ["Classificacao", "classificacao", "nivel", "categoria"],
    required: false,
    sheet: "testemunha",
    type: "string",
  },
...
export function findCanonicalFieldName(
  ...
  const exactMatch = CANONICAL_COLUMN_SYNONYMS.find(
    (col) =>
      (col.sheet === sheetType || col.sheet === "both") &&
  ...
  const caseInsensitiveMatch = CANONICAL_COLUMN_SYNONYMS.find(
    (col) =>
      ...
      (col.canonical.toLowerCase() === cleanName.toLowerCase() ||
        col.synonyms.some(
          (synonym) => synonym.toLowerCase() === cleanName.toLowerCase(),
        )),
  );
 ...
 */
export function getCanonicalRequiredFields(
  sheetType: "processo" | "testemunha",
): string[] {
  return CANONICAL_COLUMN_SYNONYMS.filter(
    (col) => col.required && (col.sheet === sheetType || col.sheet === "both"),
...
export function generateCanonicalMappingReport(
  ...
  const { mapped, unmapped, missing } = applyCanonicalMapping(
    originalHeaders,
    sheetType,
  );
  ...
  Object.values(mapped).forEach((canonical) => {
    const fieldInfo = CANONICAL_COLUMN_SYNONYMS.find(
