        ...
        <div className="space-y-4">
          ...
          <Card className="border-amber-200 bg-amber-50 dark:bg-amber-950">
            ...
            <CardContent className="text-xs text-amber-700 dark:text-amber-300 space-y-2">
              <p>
                🔒 <strong>Dados mascarados:</strong> CPFs e informações
                sensíveis são automaticamente mascarados para proteção.
              </p>
              <p>
                ⚠️ <strong>Validação obrigatória:</strong> Confirmação nos autos
                é obrigatória antes de decisões.
              </p>
            </CardContent>
          </Card>
