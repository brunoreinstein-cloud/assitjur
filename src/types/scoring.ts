...
export type ScoreClassification = 'CRITICO' | 'ALTO' | 'MEDIO' | 'BAIXO' | 'MINIMO'

export type TestemunhaClassification = 'PROFISSIONAL' | 'SUSPEITA' | 'NORMAL' | 'OCASIONAL'

export type ContradictaPriority = 'URGENTE' | 'ALTA' | 'MEDIA' | 'BAIXA' | 'NAO_RECOMENDADA'
...
export interface ScoreAlert {
  id: string
  type: 'SCORE_INCREASE' | 'NEW_CRITICAL' | 'PATTERN_DETECTED' | 'THRESHOLD_CROSSED'
