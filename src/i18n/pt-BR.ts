...
export const strings = {
  ...
  complianceFooter:
    "Validação nos autos é obrigatória. Dados tratados conforme LGPD.",
  ...
  import: {
    ...
    compliance: {
      ...
      maskedData:
        "Dados mascarados: CPFs e informações sensíveis são automaticamente mascarados para proteção.",
      mandatoryValidation:
        "Validação obrigatória: Confirmação nos autos é obrigatória antes de decisões.",
    },
  },
