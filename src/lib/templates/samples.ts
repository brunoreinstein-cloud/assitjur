...
export const dicionarioFields: DicionarioField[] = [
  // Campos obrigatórios Por Processo
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Exatamente 20 dígitos após remover pontuação. Dígitos verificadores devem ser válidos",
  ...
  },
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Nome completo do reclamante. Não pode estar vazio ou conter apenas espaços",
  ...
  },
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Nome da empresa ou pessoa ré. Não pode estar vazio ou conter apenas espaços",
  ...
  },
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Lista de advogados do polo ativo. Mínimo 1. Aceita separação por ; ou ,",
  ...
  },
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Lista de todas as testemunhas do processo. Mínimo 1. Aceita separação por ; ou ,",
  ...
  // Campos obrigatórios Por Testemunha
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Nome completo da testemunha. Não pode estar vazio ou conter apenas espaços",
  ...
  },
  {
    ...
    Obrigatorio: "Sim",
    Regra:
      "Quantidade de depoimentos prestados pela testemunha. Deve ser maior que 0",
    Exemplo: "3",
  },
  {
    Aba: "Por Testemunha",
    ...
    Obrigatorio: "Sim",
    Regra:
      "Lista de CNJs onde atuou como testemunha. Mínimo 1. Aceita formatos: JSON-like, separado por ; ou ,",
  ...
  // Campos opcionais Por Testemunha
  {
    ...
    Obrigatorio: "Não",
    Regra:
      "Nome do reclamante (será preenchido automaticamente via join com processos)",
    Exemplo: "João Silva Santos",
  },
  {
    Aba: "Por Testemunha",
    ...
    Obrigatorio: "Não",
    Regra:
      "Nome do réu (será preenchido automaticamente via join com processos)",
    Exemplo: "Empresa ABC Ltda",
  },
];
