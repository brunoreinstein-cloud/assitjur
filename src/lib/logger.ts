...
export const logError = (message: string, context?: Record<string, any>, service?: string) => 
  logger.error(message, context, service);

export const logWarn = (message: string, context?: Record<string, any>, service?: string) => 
  logger.warn(message, context, service);

export const logInfo = (message: string, context?: Record<string, any>, service?: string) => 
