 ...
 */
export function correctNameCapitalization(
  name: string,
...
function capitalizeWord(word: string): string {
  ...
  if (word.toLowerCase().startsWith("mc")) {
    return (
      "Mc" +
      word.substring(2).charAt(0).toUpperCase() +
  ...
  if (word.toLowerCase().startsWith("mac")) {
    return (
      "Mac" +
      word.substring(3).charAt(0).toUpperCase() +
