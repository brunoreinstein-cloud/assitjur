...
export const mockReportData: ConclusiveReportData = {
    ...
    triangulacao: [
      {
        ...
        cnjs: ["0001234-56.2024.5.02.0001", "0001235-57.2024.5.02.0002", "0001236-58.2024.5.02.0003"],
    ...
    duploPapel: [
      {
        ...
        cnjs_como_testemunha: ["0001238-60.2024.5.02.0005", "0001239-61.2024.5.02.0006"],
        polo_passivo: true,
        risco: 'ALTO'
      }
    ],
    ...
    homonimos: [
      {
        ...
        probabilidade: 'ALTA',
        cnjs_suspeitos: ["0001242-64.2024.5.02.0009", "0001243-65.2024.5.02.0010"]
      }
    ],
    padroes: {
      ...
      score_breakdown: {
        ...
        components: {
          duplo_papel: {
            score: 85,
            weight: 0.30,
            description: "Testemunha identificada como reclamante em outro processo",
  ...
  resumo_executivo: {
    ...
    observacoes_gerais: "A análise identificou padrões suspeitos concentrados em um pequeno grupo de testemunhas e advogados. Embora a maioria dos casos apresente baixo risco, há evidências claras de esquemas organizados de fraude testemunhal que requerem ação imediata. A concentração geográfica e temporal dos padrões sugere coordenação entre os envolvidos."
  },
