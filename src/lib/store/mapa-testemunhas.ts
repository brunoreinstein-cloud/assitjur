...
export const useMapaTestemunhasStore = create<MapaTestemunhasStore>(
  (set) => ({
    ...
    density: "comfortable",
    navigationHistory: [
      { label: "Mapa de Testemunhas", path: "/mapa-testemunhas" },
    ],
    ...
    removeProcesso: (cnj) => {
      ...
      set((state) => {
        ...
        return {
          processos: arr,
          totalProcessos: state.totalProcessos - 1,
        } as any;
      });
      return removed;
    },
    ...
    removeTestemunha: (nome) => {
      ...
      set((state) => {
        const index = state.testemunhas.findIndex(
        ...
        return {
          testemunhas: arr,
          totalTestemunhas: state.totalTestemunhas - 1,
        } as any;
      });
      return removed;
    },
    restoreTestemunha: (testemunha) =>
      set((state) => ({
        testemunhas: [testemunha, ...state.testemunhas],
        totalTestemunhas: state.totalTestemunhas + 1,
      })),
    resetFilters: () =>
      set({
    ...
    nextHint: () =>
      set((state) => ({
        currentHintIndex:
          (state.currentHintIndex + 1) % state.loadingHints.length,
      })),
...
export const selectTestemunhas = (state: MapaTestemunhasStore) =>
  state.testemunhas;
export const selectIsLoading = (state: MapaTestemunhasStore) => state.isLoading;
export const selectIsPiiMasked = (state: MapaTestemunhasStore) =>
  state.isPiiMasked;
export const selectHasError = (state: MapaTestemunhasStore) => state.hasError;
export const selectErrorMessage = (state: MapaTestemunhasStore) =>
  state.errorMessage;
export const selectLastUpdate = (state: MapaTestemunhasStore) =>
  state.lastUpdate;
export const selectProcessoFilters = (state: MapaTestemunhasStore) =>
  state.processoFilters;
export const selectTestemunhaFilters = (state: MapaTestemunhasStore) =>
  state.testemunhaFilters;
export const selectIsImportModalOpen = (state: MapaTestemunhasStore) =>
  state.isImportModalOpen;
export const selectSelectedProcesso = (state: MapaTestemunhasStore) =>
  state.selectedProcesso;
export const selectSelectedTestemunha = (state: MapaTestemunhasStore) =>
  state.selectedTestemunha;
export const selectIsDetailDrawerOpen = (state: MapaTestemunhasStore) =>
  state.isDetailDrawerOpen;
export const selectColumnVisibility = (state: MapaTestemunhasStore) =>
  state.columnVisibility;
export const selectSavedViews = (state: MapaTestemunhasStore) =>
  state.savedViews;
export const selectActiveViewName = (state: MapaTestemunhasStore) =>
  state.activeView;
