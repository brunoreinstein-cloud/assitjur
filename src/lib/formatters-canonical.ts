...
export const formatProcessoToCanonical = (
  ...
  return {
    ...
    Advogados_Ativo: formatToCanonicalList(
      processo.advogados_parte_ativa || [],
    ),
    Testemunhas_Ativo: formatToCanonicalList(
      processo.testemunhas_ativo_limpo || [],
    ),
    Testemunhas_Passivo: formatToCanonicalList(
    ...
    Qtd_Reclamante_Testemunha:
      processo.qtd_vezes_reclamante_foi_testemunha || 0,
    CNJs_Reclamante_Testemunha: formatToCanonicalList(
      processo.cnjs_em_que_reclamante_foi_testemunha || [],
    ),
    Reclamante_Testemunha_Polo_Passivo:
      processo.reclamante_testemunha_polo_passivo || false,
    ...
    Testemunhas_Prova_Emprestada: formatToCanonicalList(
      processo.testemunhas_prova_emprestada || [],
    ),
...
export const formatTestemunhaToCanonical = (
  ...
  return {
    ...
    CNJs_Triangulacao: formatToCanonicalList(
      testemunha.cnjs_triangulacao || [],
    ),
 ...
 */
export function getExpectedCanonicalHeaders(
  sheetType: "processo" | "testemunha",
): readonly string[] {
