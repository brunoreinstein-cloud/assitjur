        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              {/* Floating Indicators */}
              <div
                className="absolute -top-3 -right-3 w-12 h-12 bg-accent/10 border-2 border-accent/30 rounded-xl flex items-center justify-center shadow-lg animate-bounce"
              ...
              <div
                className="absolute -bottom-3 -left-3 w-12 h-12 bg-primary/10 border-2 border-primary/30 rounded-xl flex items-center justify-center shadow-lg animate-bounce"
