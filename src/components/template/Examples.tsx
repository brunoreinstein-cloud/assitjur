      ...
      <CardContent>
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Exemplos - Aba "Por Processo"
              </CardTitle>
              <CardDescription>
                Cada linha representa um processo com campos obrigatórios
                preenchidos
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {processoExamples.map((exemplo, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell className="text-xs max-w-32 truncate">
                          {exemplo.advogados_ativo}
                        </TableCell>
                        <TableCell className="text-xs max-w-32 truncate">
                          {exemplo.todas_testemunhas}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                <strong>Campos obrigatórios:</strong> cnj, uf, comarca,
                reclamante_nome, reu_nome, advogados_ativo, todas_testemunhas
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Exemplos - Aba "Por Testemunha"
              </CardTitle>
              <CardDescription>
                Cada linha representa uma testemunha com lista de CNJs em
                diferentes formatos
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-1 text-xs text-muted-foreground mt-2">
                <p>
                  <strong>Campos obrigatórios:</strong> nome_testemunha,
                  qtd_depoimentos, cnjs_como_testemunha
                </p>
                <p>
                  <strong>Formatos aceitos para cnjs_como_testemunha:</strong>
                </p>
