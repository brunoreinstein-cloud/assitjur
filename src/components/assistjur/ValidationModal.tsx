        ...
        <div className="space-y-6">
          ...
          {report.summary.error_count > 0 ? (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Encontrados {report.summary.error_count} erros que impedem a
                publicação dos dados. Corrija os erros e faça um novo upload.
              </AlertDescription>
            </Alert>
            ...
            <Alert variant="default" className="border-yellow-500">
              ...
              <AlertDescription>
                Dados válidos com {report.summary.warning_count} avisos. Revise
                os avisos antes de publicar.
              </AlertDescription>
            </Alert>
          ) : (
            <Alert className="border-success">
              ...
              <AlertDescription>
                Todos os dados foram validados com sucesso! Pronto para
                publicação.
              </AlertDescription>
            </Alert>
          )}
              ...
              <CardContent>
                <div className="space-y-4">
                  {report.samples.processos.length > 0 && (
                    <div>
                      <h4 className="font-medium mb-2">
                        Por Processo ({report.samples.processos.length}{" "}
                        amostras)
                      </h4>
                      <div className="text-xs bg-muted p-2 rounded overflow-x-auto">
                        <pre>
                          {JSON.stringify(
                            report.samples.processos.slice(0, 3),
                            null,
                            2,
                          )}
                        </pre>
                  ...
                  {report.samples.testemunhas.length > 0 && (
                    <div>
                      <h4 className="font-medium mb-2">
                        Por Testemunha ({report.samples.testemunhas.length}{" "}
                        amostras)
                      </h4>
                      <div className="text-xs bg-muted p-2 rounded overflow-x-auto">
                        <pre>
                          {JSON.stringify(
                            report.samples.testemunhas.slice(0, 3),
                            null,
                            2,
                          )}
                        </pre>
