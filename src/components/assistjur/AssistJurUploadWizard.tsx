        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-semibold text-foreground mb-2">Abas obrigatórias:</h4>
              <ul className="space-y-1 text-sm text-muted-foreground">
                <li>• <strong>Por Processo:</strong> cnj, uf, comarca, advogados_ativo, todas_testemunhas</li>
                <li>• <strong>Por Testemunha:</strong> nome_testemunha, qtd_depoimentos, cnjs_como_testemunha</li>
              </ul>
            </div>
            ...
            <div className="flex items-start gap-2 text-sm text-amber-700 bg-amber-50 p-3 rounded-lg">
              ...
              <div>
                <strong>Sinônimos aceitos:</strong> "Advogados (Polo Ativo)", "testemunhas_todas", "CNJs_Como_Testemunha" e outras variações
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">
                    {isDragActive ? 'Solte o arquivo aqui...' : 'Envie sua planilha Excel'}
                  </h3>
                  <p className="text-muted-foreground mt-1">
                    Arraste e solte ou clique para selecionar um arquivo .xlsx ou .xls (máx. 50MB)
                  </p>
                </div>
                {!isDragActive && (
