...
export const ConclusiveReportTemplate = React.forwardRef<
  HTMLDivElement,
  ConclusiveReportTemplateProps
>(
  (
    { data, onExport, sections = { summary: true, risks: true, roi: true } },
    ref,
  ) => {
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>
                    Período: {data.periodo_analise.inicio} a{" "}
                    {data.periodo_analise.fim}
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                  ...
                  .map((processo) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <Badge
                          variant={
                            processo.score_final >= 85
                              ? "destructive"
                              : processo.score_final >= 70
                                ? "destructive"
                                : "secondary"
                          }
                          className="font-mono"
                ...
                {data.processos_scores.filter((p) => p.score_final >= 85)
                  .length === 0 && (
        ...
        {sections.roi && data.roi && (
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div>
                Investimento: R$ {data.roi.investimento.toLocaleString()}
              </div>
