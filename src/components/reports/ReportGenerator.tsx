...
export function ReportGenerator({
  ...
  const [generatedReport, setGeneratedReport] =
    useState<ConclusiveReportData | null>(null);
  ...
  const handleGenerateReport = async () => {
    if (
      !config.organizacao ||
      !config.periodo_inicio ||
      !config.periodo_fim ||
      !config.analista_responsavel
    ) {
      toast({
        ...
        reportData = {
          ...
          resumo_executivo: {
            ...
            observacoes_gerais:
              ...
              mockData.resumo_executivo.observacoes_gerais,
          },
          recomendacoes: {
            imediatas:
              config.recomendacoes_personalizadas.imediatas.length > 0
                ? config.recomendacoes_personalizadas.imediatas
                : mockData.recomendacoes.imediatas,
            curto_prazo:
              config.recomendacoes_personalizadas.curto_prazo.length > 0
                ? config.recomendacoes_personalizadas.curto_prazo
                : mockData.recomendacoes.curto_prazo,
            longo_prazo:
              config.recomendacoes_personalizadas.longo_prazo.length > 0
  ...
  const removeRecommendation = (
    type: keyof typeof config.recomendacoes_personalizadas,
    index: number,
  ) => {
    setConfig((prev) => ({
      ...prev,
      recomendacoes_personalizadas: {
        ...prev.recomendacoes_personalizadas,
        [type]: prev.recomendacoes_personalizadas[type].filter(
          (_, i) => i !== index,
        ),
      },
    }));
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setConfig((prev) => ({
                      ...prev,
                      analista_responsavel: e.target.value,
                    }))
                  }
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setConfig((prev) => ({
                      ...prev,
                      incluir_casos_criticos: checked,
                    }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setConfig((prev) => ({
                      ...prev,
                      incluir_analise_padroes: checked,
                    }))
                  }
                />
              </div>
                ...
                <div className="ml-4 space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({
                        ...prev,
                        limite_casos_criticos: parseInt(e.target.value) || 10,
                      }))
                    }
                  />
                </div>
          ...
          {config.incluir_recomendacoes && (
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                {Object.entries(config.recomendacoes_personalizadas).map(
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  removeRecommendation(
                                    type as keyof typeof config.recomendacoes_personalizadas,
                                    index,
                                  )
                                }
