...
export function BiancaSection() {
  ...
  return (
    <section
      id="bianca-section"
      className="py-20 bg-gradient-to-br from-muted/10 to-background relative overflow-hidden"
    >
      {/* Background Effects */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="relative inline-block mb-8">
              <div className="w-40 h-40 mx-auto bg-gradient-to-br from-primary via-accent to-primary rounded-full p-1 shadow-glow animate-pulse">
                <div className="w-full h-full bg-gradient-to-br from-background/20 to-background/40 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/20">
                  <span className="text-3xl font-bold bg-gradient-to-br from-primary-foreground to-accent-foreground bg-clip-text text-transparent">
                    BR
                  </span>
                </div>
              </div>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Mais de duas décadas transformando a gestão do contencioso
              jurídico em grandes corporações através de
            ...
            <p className="text-muted-foreground leading-relaxed max-w-4xl mx-auto">
              A criadora do AssistJur.IA é referência nacional em gestão
              estratégica de passivos judiciais e inovação jurídica. Sua
              trajetória combina advocacia de banca, liderança corporativa e
              consultoria estratégica, sempre com foco em resultados mensuráveis
                ...
                {timeline.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Card
                          className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-primary/30 cursor-pointer"
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center justify-between mb-3">
                                  <Badge
                                    variant="outline"
                                    className="bg-gradient-to-r from-primary/10 to-accent/10 border-primary/30 text-primary text-xs"
                                  >
                                    {item.period}
                                  </Badge>
                                  {isExpanded ? (
