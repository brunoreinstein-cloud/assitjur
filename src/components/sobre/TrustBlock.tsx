...
const testimonials = [
  {
    quote: "Bianca transformou completamente nossa gestão de contencioso. Sua visão estratégica e domínio técnico são impressionantes.",
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {testimonials.map((testimonial, index) => (
                <Card key={index} className="hover:shadow-xl transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: `${index * 200}ms` }}>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {certifications.map((cert, index) => {
                ...
                return (
                  <Card key={index} className="hover:shadow-lg transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: `${index * 150}ms` }}>
                    <CardContent className="p-6 text-center">
                      ...
                      <h4 className="font-semibold text-foreground mb-2">{cert.label}</h4>
