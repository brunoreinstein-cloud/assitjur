...
export function FinalCTA({ onOpenBetaModal }: FinalCTAProps) {
  return (
    <section
      id="cta-final"
      className="py-20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 relative overflow-hidden"
    >
      {/* Background Effects */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
              Seja um dos primeiros a acessar o AssistJur.IA e transforme a
              forma como sua empresa ou escritório gerencia passivos judiciais
              com a experiência de duas décadas no mercado.
            </p>
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-muted-foreground">
              <strong>Apenas 100 vagas disponíveis</strong> • Inscrições
              encerram em breve
            </p>
          </div>
        </div>
