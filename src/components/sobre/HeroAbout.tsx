        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Criado por <strong className="text-foreground">Bianca Reinstein</strong>, especialista com mais de 20 anos de atuação em grandes carteiras judiciais, transformando a gestão do contencioso através da inteligência artificial.
            </p>
              ...
              <div className="relative bg-gradient-to-br from-background/90 to-background/70 backdrop-blur-sm rounded-3xl p-8 border-2 border-primary/20 shadow-glow">
                <div className="text-center space-y-6">
                  ...
                  <div className="relative">
                    <div className="w-40 h-40 mx-auto bg-gradient-to-br from-primary via-accent to-primary rounded-full p-1 shadow-glow">
                      <div className="w-full h-full bg-gradient-to-br from-background/10 to-background/30 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/20">
                        <span className="text-4xl font-bold bg-gradient-to-br from-primary-foreground to-accent-foreground bg-clip-text text-transparent">BR</span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-foreground">Bianca Reinstein</h3>
                    <p className="text-muted-foreground">Especialista em Contencioso Jurídico</p>
                    <div className="flex justify-center gap-2 flex-wrap">
                      <Badge variant="secondary" className="text-xs">OAB/SP</Badge>
