            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="termos" className="text-xs leading-5">
                  Aceito os <a href="/termos" className="text-primary underline">termos de uso</a> e 
                  <a href="/privacidade" className="text-primary underline ml-1">política de privacidade</a> *
                </Label>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setFormData({...formData, aceiteComunicacao: checked as boolean})}
                />
                <Label htmlFor="comunicacao" className="text-xs leading-5">
                  Desejo receber conteúdos sobre compliance LGPD e novidades do AssistJur.IA
                </Label>
              </div>
            </div>
