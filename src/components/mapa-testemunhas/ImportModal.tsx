...
export function ImportModal() {
  ...
  const [currentStep, setCurrentStep] = useState<
    "upload" | "validation" | "preview" | "publish"
  >("upload");
  ...
  const processFileValidation = async (file: File) => {
    await withErrorHandling(async () => {
      const { porProcesso, porTestemunha, errors, warnings } =
      ...
      reader.onload = (e) => {
        try {
          ...
          if (!sheetProc && !sheetTest) {
            throw new Error(
              'Arquivo deve conter ao menos uma aba: "Por Processo" ou "Por Testemunha".',
            );
          }
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      if (testemunhasExplodidas.length)
        payload.testemunhas = testemunhasExplodidas;
              ...
              <div className="space-y-3">
                <Alert className="border-blue-200 bg-blue-50 dark:bg-blue-950">
                  ...
                  <AlertDescription className="text-blue-800 dark:text-blue-200">
                    <strong>Formato requerido:</strong> Arquivo Excel (.xlsx)
                    com abas:
                    <br />• <strong>Por Processo:</strong> CNJ,
                    Reclamante_Limpo, Reu_Nome
                    <br />• <strong>Por Testemunha:</strong> Nome_Testemunha,
              ...
              validationResults.validRows > 0 && (
                <Alert className="border-green-200 bg-green-50 dark:bg-green-950 dark:border-green-800">
                  ...
                  <AlertDescription className="text-green-800 dark:text-green-200">
                    ...
                    {validationResults.validRows} registros serão processados.
                  </AlertDescription>
                </Alert>
              )}
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-muted rounded-lg">
              <div className="text-2xl font-bold">
                {validationResults?.testemunhas.length || 0}
              </div>
          ...
          <Alert className="border-blue-200 bg-blue-50 dark:bg-blue-950 dark:border-blue-800">
            ...
            <AlertDescription className="text-blue-800 dark:text-blue-200">
              ...
              {validationResults?.validRows || 0} registros serão processados e
              inseridos no mapa de testemunhas.
            </AlertDescription>
          </Alert>
  ...
  const renderPublishStep = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Processamento dos dados no sistema</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {!finalResult ? (
      ...
      <Dialog open={isImportModalOpen} onOpenChange={handleOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Importe dados do Excel com as abas "Por Processo" e/ou "Por
              Testemunha"
            </DialogDescription>
          </DialogHeader>
