...
import { useMapaTestemunhasStore, selectSavedViews, selectActiveViewName } from "@/lib/store/mapa-testemunhas";
...
export function VisualizationSelector({ userId }: VisualizationSelectorProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      <Select value={activeView || ''} onValueChange={v => setActiveViewName(v, userId)}>
