...
import { useMapaTestemunhasStore, selectActiveTab, selectColumnVisibility } from "@/lib/store/mapa-testemunhas";
...
export function ColumnVisibilityMenu() {
  ...
  const setColumnVisibility = useMapaTestemunhasStore(s => s.setColumnVisibility);

  const columns = activeTab === 'processos'
    ? [
        { key: 'cnj', label: 'CNJ' },
        { key: 'uf', label: 'UF' },
      ...
      <DropdownMenuContent align="end">
        {columns.map(col => (
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={v => setColumnVisibility(activeTab, col.key, v as boolean)}
          >
            {col.label}
          </DropdownMenuCheckboxItem>
        ))}
