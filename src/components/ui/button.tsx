...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95 hover:scale-105 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-md hover:shadow-lg rounded-lg font-medium relative overflow-hidden",
        destructive:
        ...
        professional: "bg-gradient-primary text-primary-foreground shadow-premium hover:shadow-glow transition-all duration-300 font-semibold",
        ...
        premium: "bg-gradient-card border border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground shadow-premium hover:shadow-glow transition-all duration-300"
      },
      size: {
