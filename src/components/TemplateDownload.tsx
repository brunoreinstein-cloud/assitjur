    ...
    <Card className="w-full max-w-2xl">
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            Este template contém 10 registros de exemplo com todas as colunas esperadas pelo sistema.
          </AlertDescription>
        </Alert>
        ...
        <div className="bg-muted p-4 rounded-lg space-y-2">
          ...
          <ul className="text-sm space-y-1 text-muted-foreground">
            ...
            <li>• Use no máximo 10.000 linhas por arquivo</li>
            <li>• CNJ deve seguir o padrão: 1234567-12.2024.5.01.0001</li>
