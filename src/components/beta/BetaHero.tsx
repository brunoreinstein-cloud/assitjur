...
export function BetaHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-accent/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
              <div className="text-lg font-semibold text-muted-foreground">Escritórios de Grande Porte</div>
              <div className="text-lg font-semibold text-muted-foreground">Departamentos Jurídicos</div>
              <div className="text-lg font-semibold text-muted-foreground">Consultorias</div>
            </div>
          </div>
        </div>
      </div>
