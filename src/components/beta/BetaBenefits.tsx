      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Mais do que acesso antecipado, você terá a oportunidade de moldar o
            futuro da gestão do contencioso com IA.
          </p>
        </div>
          ...
          <div className="text-center">
            <div className="flex justify-center items-center space-x-2 mb-4">
              ...
              <span className="font-semibold text-foreground">
                Programa Beta Limitado
              </span>
            </div>

            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Aceitamos apenas <strong>100 participantes</strong> para garantir
              qualidade no feedback e suporte personalizado para cada beta
              tester.
            </p>
