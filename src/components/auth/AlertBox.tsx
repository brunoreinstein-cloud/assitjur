...
const alertVariants = cva("border-l-4", {
  variants: {
    variant: {
...
export const AlertBox = ({
  ...
  return (
    ...
    >
      ...
      {title && <AlertTitle className={getTextColor()}>{title}</AlertTitle>}
      <AlertDescription className={getTextColor()}>{children}</AlertDescription>
    </Alert>
  );
};
