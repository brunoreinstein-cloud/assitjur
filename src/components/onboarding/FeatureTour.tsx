  ...
  mapa: [
    {
      ...
      content:
        "Use os filtros para refinar sua busca por processos e testemunhas específicas.",
      disableBeacon: true,
      placement: "bottom",
    },
    {
      ...
      content:
        "Visualize e analise os dados em formato de tabela. Clique em qualquer linha para ver mais detalhes.",
      placement: "top",
    },
    {
      target: '[data-tour="chat"]',
      content:
        "Converse com a IA para fazer perguntas sobre seus dados e obter insights instantâneos.",
      placement: "left",
    },
    {
      target: '[data-tour="export"]',
      content:
        "Exporte seus dados filtrados em diversos formatos (Excel, PDF, etc.).",
      placement: "bottom",
    },
  ],
  dashboard: [
    ...
    },
    {
      ...
      content:
        "Visualize tendências e padrões através de gráficos interativos.",
      placement: "top",
    },
    {
  ...
  admin: [
    {
      ...
      content:
        "Configure os modelos de IA e ajuste os parâmetros para melhor performance.",
      disableBeacon: true,
      placement: "bottom",
    },
    {
    ...
    },
    {
      ...
      content:
        "Gerencie configurações da organização e permissões de usuários.",
      placement: "bottom",
    },
  ],
};
...
export function FeatureTour({ type, run = false, onFinish }: FeatureTourProps) {
  ...
  const hasCompletedTour =
    localStorage.getItem(`tour-${type}-completed`) === "true";
...
export function useTour(type: TourType) {
  ...
  return {
    ...
    resetTour,
    FeatureTour: () => (
      <FeatureTour type={type} run={run} onFinish={() => setRun(false)} />
    ),
  };
}
