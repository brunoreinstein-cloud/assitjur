        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Selecione o arquivo CSV ou XLSX</h3>
              <p className="text-muted-foreground text-sm">
                Arquivo deve conter as colunas obrigatórias: cnj, comarca, reclamante_nome, etc.
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Base Publicada com Sucesso</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <Card className="bg-gradient-card">
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Versão da Base:</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">{validationResults.validRows}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <code className="text-xs bg-muted px-2 py-1 rounded">a1b2c3d4...</code>
                </div>
              </CardContent>
            </Card>

            <Button onClick={onComplete} variant="professional" className="w-full" size="lg">
          ...
          return (
            <div key={stepItem.id} className="flex items-center">
              ...
              {index < steps.length - 1 && (
                <div className={`w-12 h-0.5 mx-2 ${step > stepItem.id ? 'bg-success' : 'bg-border'}`} />
              )}
            </div>
          )
        })}
