...
export function TransferUserDialog({ open, onOpenChange, user, onSuccess }: TransferUserDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('super-admin-transfer-user', {
        body: {
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              O usuário será removido da organização atual e adicionado à nova organização. Esta ação será registrada no log de auditoria.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-2">
            ...
            <Select value={newOrgId} onValueChange={setNewOrgId} disabled={isLoading}>
