...
const SystemConfig = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Parâmetros & Regras</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-3 bg-muted rounded-lg">
              <p className="text-sm">
                <strong>Impacto:</strong> Processos e testemunhas dentro de {triangulationWindow} meses 
                serão considerados para identificação de padrões suspeitos.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-3 bg-muted rounded-lg">
              <p className="text-sm">
                <strong>Exemplo:</strong> {cpfMaskEnabled ? '123.456.789-**' : '123.456.789-00'}
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              <div className="space-y-2">
                <Label>Reclamante foi Testemunha: {scoreWeights.reclamante_foi_testemunha}%</Label>
                <Slider
                  value={[scoreWeights.reclamante_foi_testemunha]}
                  onValueChange={(value) => setScoreWeights(prev => ({
                    ...prev,
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label>Triangulação Confirmada: {scoreWeights.triangulacao_confirmada}%</Label>
                <Slider
              ...
              <div className="space-y-2">
                <Label>Prova Emprestada: {scoreWeights.prova_emprestada}%</Label>
                <Slider
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Select 
                value={exportLimits.admin_limit === -1 ? "unlimited" : "limited"}
                onValueChange={(value) => setExportLimits(prev => ({
                  ...prev,
