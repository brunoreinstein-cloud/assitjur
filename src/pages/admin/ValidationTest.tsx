      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-3xl font-bold">
            Validação do Corretor Inteligente
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-success/20 bg-success/5">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Campos legados adicionados (reclamante_nome, reu_nome) para
          ...
          <Card className="border-primary/20 bg-primary/5">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Sistema de correção automática com mapeamento flexível e
                validação real
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-warning/20 bg-warning/5">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Processamento de arquivos reais CSV/XLSX com interface
                interativa
              </p>
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-t pt-4">
              <p className="text-sm text-muted-foreground">
                <strong>Resultado:</strong> Sistema robusto que elimina os erros
                de importação, permitindo que usuários importem dados com
                correções automáticas e interface amigável para revisar todas as
                modificações antes da publicação.
              </p>
            </div>
          </CardContent>
        </Card>
