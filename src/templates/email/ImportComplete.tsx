...
export const importCompleteEmailTemplate = {
  subject: (fileName: string) =>
    `Importação concluída - ${fileName} processado com sucesso!`,
  previewText: (fileName: string) =>
    `Importação concluída - ${fileName} processado com sucesso!`,
  ...
  structure: {
    ...
    content: {
      ...
      mainText:
        "Sua importação de dados foi processada com sucesso e está pronta para análise!",
      nextSteps: [
